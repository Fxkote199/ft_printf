...
void				ft_w_p_star(t_print *pr, va_list ap,\
ptrdiff_t *w, ptrdiff_t *p);
void				ft_w_p_same(t_print *pr, size_t i);
void				ft_w_p_1(t_print *pr, ptrdiff_t w, ptrdiff_t p, int type);
void				ft_w_p_2(t_print *pr, ptrdiff_t precis,\
...
void				ft_only_prec_str_1(t_print *pr, ptrdiff_t l,\
ptrdiff_t p, int *arr);
...
void				ft_fl_zr(t_print *pr, ptrdiff_t width,\
ptrdiff_t precis, int ch);
void				ft_fl_srp_1(t_print *pr, ptrdiff_t width,\
ptrdiff_t precis, int ch);
void				ft_sp_zr(t_print *pr, ptrdiff_t width,\
ptrdiff_t precis, int ch);
...
void				ft_only_width_1(t_print *pr, ptrdiff_t w,\
ptrdiff_t l, char **arr);
int					ft_utf(t_print *pr, t_utf *uf);
